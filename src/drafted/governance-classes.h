 ...
 *
 *   // network
 *   CTrioneNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.trione.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTrioneNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TrioneNetwork
// //   -- signature requirements : Key1(User)
// class CTrioneNetworkVariable : public CGovernanceObject
// {
// private:
