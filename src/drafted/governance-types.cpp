...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "TrioneNetwork") type = TrioneNetwork;
    if(strType == "TrioneNetworkVariable") type = TrioneNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == TrioneNetwork) s = "TrioneNetwork";
    if(type == TrioneNetworkVariable) s = "TrioneNetworkVariable";
