    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Trione Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Trione Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  trione-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Trione in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TRIONE, 0.1 TRIONE, 1 TRIONE and 10 TRIONE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://trionecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://trionecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Trione Core is shutting down...") + "<br /><br />" +
