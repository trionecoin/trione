    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TRIONE-light"), QVariant("light"));
    ui->theme->addItem(QString("TRIONE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TRIONE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TRIONE-traditional"), QVariant("trad"));
