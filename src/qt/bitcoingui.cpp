    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Trione Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trione address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trione: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Trione Core"), this);
    aboutAction->setStatusTip(tr("Show information about Trione Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Trione Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trione addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trione addresses"));
    ...
    openAction->setStatusTip(tr("Open a trione: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Trione Core help message to get a list with possible Trione Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Trione Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trione network", "", count));
}
...
{
    QString strTitle = tr("Trione Core"); // default title
