...
{
    if(fLiteMode) return; // ignore all Trione related functionality
...
/*
    ...
    allow endless transaction that would bloat Trione and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("trione-privatesend");
