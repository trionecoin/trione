...
This mechanism has been integrated into Bitcore-Node-Trione which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/trionecoin/insight-api-trione#web-socket-api](https://github.com/trionecoin/insight-api-trione#web-socket-api) 
* API: [https://github.com/trionecoin/insight-api-trione#instantsend-transactions](https://github.com/trionecoin/insight-api-trione#instantsend-transactions) 
...
By default, the Trione Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Trione Core daemon:
