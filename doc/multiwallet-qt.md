...
Only requiring some minor changes is trione.cpp.
...
Changes to trione.cpp
----------------------
trione.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
