...
Trione Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Trione Core, where everyone uses
...
pay attention to for reviewers of Trione Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Trione Core uses tinyformat, which is type safe. Leave them out to avoid confusion
